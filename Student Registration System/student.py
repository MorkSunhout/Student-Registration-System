...
class Student:
    def __init__(self,root):
       ...
       #1st image 
        ...
        #background image
        img_4=Image.open(r'STUDENT REGISTRATION SYSTEM/338573344_957585705599474_6059341756005249717_n.jpg')
        img_4=img_4.resize((1350,150),Image.BILINEAR)
        ...
        img_5=Image.open(r'STUDENT REGISTRATION SYSTEM/Student-Life.jpg')
        img_5=img_5.resize((500,180),Image.BILINEAR)
        ...
        #img 1
        img_7=Image.open(r'STUDENT REGISTRATION SYSTEM/AUPP-Building.jpg')
        img_7=img_7.resize((450,180),Image.BILINEAR)
    ...
    def add_data(self):
        if (self.var_enrollment.get()=="" or self.var_name.get()=="" or self.var_course.get()==""):
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="hout1688",database="student_management_system")
